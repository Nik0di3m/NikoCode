...
const AboutMe = () => {
  return (
    <section
      className="flex flex-col items-center justify-center about"
      id="about"
    >
      {/* Main container */}
      ...
      <div className="flex-col flex lg:flex-row justify-around items-center">
        ...
        <article className="w-[90%] p-2 text-justify lg:text-left dark:text-secondary items-center lg:w-2/6 h-80 lg:p-4 flex flex-col justify-center lg:items-start break-words">
          ...
          <p className="w-5/6 font-light">
            Web developer, with passion, knowledge and experience, working in
            web, mobile developing. Administrator in website and online shop.
            Extensive knowledge in React, React Native, Next.js, Firebase,
            Express.js.
          </p>
          ...
          <Button
            ...
            link="/CV_Norbert_Waleszczyk.pdf"
          />
        </article>
      </div>
    </section>
