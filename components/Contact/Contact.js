                ...
                <div className="lg:w-2/4 text-light">
                    ...
                    >
                        <input
                            ...
                            type="text"
                            placeholder="Name:"
                            className="rounded-2xl bg-orange p-[3px] w-full placeholder-light outline-none mb-2 pl-2"
                        />
                        <input
                            {...register('email', {
                                required: true,
                        ...
                        <textarea
                            ...
                            placeholder="Messege:"
                            style={{ height: '22rem' }}
                            className="rounded-2xl bg-orange p-[3px] w-full placeholder-light outline-none mb-2 pl-2 h-80 resize-none"
                        />
                        <button
                            type="submit"
                            className="bg-orange p-2 w-36 rounded-2xl hover:scale-110 duration-200"
                        >
                            Send
                        </button>
                    </form>
